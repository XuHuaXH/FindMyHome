...
public class GeoLocation {
    ...
    public static void main(String[] args) {
        GeoLocation location = fromDegrees(34, -118);
        GeoLocation[] result = location.boundingCoordinates(30, EARTH_RADIUS_IN_KM);
        for (GeoLocation gl : result) {
            System.out.println(location.distanceTo(gl, EARTH_RADIUS_IN_KM));
        }
    }
